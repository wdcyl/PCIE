...
module axil_acquisition_regs #(parameter integer ADDR_WIDTH=32) (
    ...
    output logic dds_apply_pulse_o,output logic [27:0] dds_ftw_o,output logic dds_triangle_o
);
    ...
    localparam [11:0] REG_DDS_FTW=12'h02c,REG_DDS_CONTROL=12'h030;
    ...
    function automatic mapped(input [11:0] a); begin case(a)
        ...
        REG_CAPTURED,REG_WRITTEN_LO,REG_WRITTEN_HI,REG_DDS_FTW,REG_DDS_CONTROL:mapped=1; default:mapped=0; endcase end endfunction
    function automatic [31:0] read_value(input [11:0] a); begin case(a)
        REG_ID:read_value=32'h4144_3932; REG_VERSION:read_value=32'h0003_0000; REG_STATUS:read_value=status_i;
        ...
        REG_DDS_FTW:read_value={4'd0,dds_ftw_o}; REG_DDS_CONTROL:read_value={31'd0,dds_triangle_o};
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if(!rst_ni) begin
            ...
            dds_apply_pulse_o<=0;dds_ftw_o<=28'h0a3d70a;dds_triangle_o<=0;
        end else begin
            ...
            if(write_commit)begin
                ...
                case(write_addr)
                    ...
                    REG_DDS_CONTROL:if(write_strb[0])begin dds_triangle_o<=write_data[0];dds_apply_pulse_o<=write_data[1];end
                    default:begin end
                endcase
